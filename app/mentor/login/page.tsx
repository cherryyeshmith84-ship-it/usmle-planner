...
const ERROR_MESSAGES: Record<string, string> = {
  not_mentor: "That account isn't registered as a mentor. Please use the student login instead.",
};
...
function MentorLoginForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!mentorRow) {
      ...
      setLoading(false);
      setError("That account isn't registered as a mentor. Please use the student login instead.");
      return;
    }
  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-6">
      <div className="card max-w-md w-full">
        ...
        <h1 className="text-xl font-bold mb-1">Mentor login</h1>
        <p className="text-sm text-slate-300 mb-6">Log in to your mentor dashboard.</p>
